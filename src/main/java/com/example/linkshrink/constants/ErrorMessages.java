...
public class ErrorMessages {
    ...
    public static final String INBOUND_URL_INVALID = "[LINKSHRINK-E001] Ivalid inbound url";
    public static final String URL_NOT_FOUND = "[LINKSHRINK-E002] Url was not found";
    public static final String URL_HAS_EXPIRED = "[LINKSHRINK-E003] Url has expired";
